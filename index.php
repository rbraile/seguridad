            ...
            <div class="row">
                <div class="col-md-6">
                     <div class="panel panel-default">
                                ...
                                <div class="panel-heading">Precios la semana actual</div>
                                    <?php
                     ...
                     <div class="panel panel-default">
                        ...
                        <div class="">
                            <form action="comentario.php" method="POST">
                                <label class="cometarioLabel">Comentario</label>
                                <textarea name="comentario" class="form-control" rows="3">
                                    
                                </textarea>
                                <input type="submit"  class="btn btn-default " value="Comentar" name="comentar" />
                            </form>
                        </div>
                    </div>
